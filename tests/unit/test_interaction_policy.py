...
def test_extract_requested_scopes_dedupes_numeric_alias_when_named_scope_exists() -> None:
    scopes = extract_requested_scopes("que es la iso 9001?", profile=_profile())
    assert scopes == ("ISO 9001",)
